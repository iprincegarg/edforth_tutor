                        ...
                        <tbody>
                            <?php foreach ($data['tickets'] as $ticket): ?>
                                <tr style="border-bottom: 1px solid #e2e8f0; transition: background 0.2s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='transparent'">
                                    ...
                                    <td style="padding: 12px;">
                                        <a href="<?php echo URLROOT; ?>/tutor-dashboard/viewTicket/<?php echo $ticket->id; ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600; font-size: 0.9rem;">View</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<div id="raiseTicketModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); z-index:9999; justify-content:center; align-items:center;">
    <div style="background:#fff; padding:2rem; border-radius:8px; width:500px; max-width:90%;">
        ...
        <form action="<?php echo URLROOT; ?>/tutor-dashboard/raiseTicket" method="POST">
            ...
            <div style="display:flex; justify-content:flex-end; gap:10px; margin-top:20px; border-top: 1px solid #e2e8f0; padding-top: 15px;">
                <button type="button" class="btn tutor-btn-cancel" onclick="document.getElementById('raiseTicketModal').style.display='none'" style="padding: 8px 16px; border: 1px solid #cbd5e1; background: #fff; color: #475569; border-radius: 4px; font-weight: 600; cursor: pointer;">Cancel</button>
