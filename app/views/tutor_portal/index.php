...
<div class="auth-container" style="margin-top: 150px; min-height: 60vh; display: flex; justify-content: center; align-items: center; background-color: #f4f7f6;">
    <div class="card" style="width: 100%; max-width: 400px; padding: 20px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); border-radius: 8px; background: white;">
        ...
        <h1 class="card-title" style="font-size: 24px; color: #333;">Tutor Portal</h1>
            <p class="card-subtitle" style="color: #666; font-size: 14px;">Sign in to your Tutor account or sign up to become a tutor.</p>
        </div>

        <form action="<?php echo URLROOT; ?>/tutor-portal/login" method="POST">
            ...
            <div class="text-center" style="margin-top: 10px; padding-top: 15px; border-top: 1px solid #eee; text-align: center;">
                ...
                <a href="<?php echo URLROOT; ?>/register-as-tutor" class="btn btn-outline-primary" style="width: 100%; text-decoration: none; display: inline-block; text-align: center; padding: 10px; border: 1px solid #007bff; color: #007bff; border-radius: 4px; box-sizing: border-box;">Sign Up as a Tutor</a>
            </div>
        </form>
    </div>
</div>
