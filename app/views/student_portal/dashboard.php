    ...
    <div class="col-12">
        <div class="card" style="max-width: 100%;">
            ...
            <div class="card-body" style="padding: 20px;">
                <p style="margin-bottom: 20px;">Welcome to your Student Dashboard. Here you will be able to manage your profile, view your assigned students, and track your schedule.</p>
                ...
                <div class="alert alert-info mt-4">
                    <strong>Note:</strong> More features for the Student Dashboard will be added soon!
                </div>
            </div>
        </div>
    </div>
