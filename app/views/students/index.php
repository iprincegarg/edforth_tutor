                                ...
                                ?>
                                    <tr class="student-sections-tr">
                                        ...
                                        <td class="student-sections-td-actions" style="justify-content: flex-start; gap: 8px;">
                                            ...
                                            <form action="<?php echo URLROOT; ?>/students/toggle_access" method="POST" style="display:inline;" title="<?php echo ($sub->login_status == 1) ? 'Disable Access' : 'Enable Access'; ?>" onsubmit="return confirm('Are you sure you want to <?php echo ($sub->login_status == 1) ? 'disable' : 'enable'; ?> access for this user?');">
                                            ...
                                            <form action="<?php echo URLROOT; ?>/students/delete_account" method="POST" style="display:inline;" class="action-form-inline" onsubmit="return confirm('WARNING: Are you sure you want to permanently delete this user account and their submission? This cannot be undone.');">
                                                <input type="hidden" name="submission_id" value="<?php echo $sub->id; ?>">
                                ...
                                ?>
                                    <tr class="student-sections-tr">
                                        ...
                                        <td class="student-sections-td-actions" style="justify-content: flex-start; gap: 8px;">
                                            ...
                                            <form action="<?php echo URLROOT; ?>/students/delete_account" method="POST" style="display:inline;" class="action-form-inline" onsubmit="return confirm('WARNING: Are you sure you want to permanently delete this submission? This cannot be undone.');">
                                                <input type="hidden" name="submission_id" value="<?php echo $sub->id; ?>">
